...
public class MemCacheUtil {
	 ...
	 * @return
	 */
	public static boolean add(String key,Serializable value,boolean isReplace)
	{
		Lock lock=new ReentrantLock();
		boolean flag=false;
		try
	 ...
	 * @return
	 */
	public static boolean add(String key,Serializable value,Integer expiry,boolean isReplace)
	{
		Lock lock=new ReentrantLock();
		boolean flag=false;
		try
	 ...
	 * @return
	 */
	public static boolean replace(String key,Serializable value)
	{
		Lock lock=new ReentrantLock();
		try
		{
	 ...
	 * @return
	 */
	public static boolean replace(String key,Serializable value,Integer expiry)
	{
		Lock lock=new ReentrantLock();
		try
		{
