package com.echounion.boss.Tracking.fesco;
...
public class FESCOTracking extends AbstractTrack {

	private Logger logger=Logger.getLogger(FESCOTracking.class);
	...
	public TrackingInfo doTrack(String url, Map<String, Object> params,boolean isPost){
		...
		try
		{
			...
			info.setTitle("FESCO Tracking Result");
			if (entity != null) {
				String data = EntityUtils.toString(entity);
				Parser parser = new Parser(data);
				AndFilter filter = getAndFilter("table", "bgcolor", "#DEEDFE");
