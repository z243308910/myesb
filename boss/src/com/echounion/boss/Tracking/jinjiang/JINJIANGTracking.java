package com.echounion.boss.Tracking.jinjiang;
...
public class JINJIANGTracking extends AbstractTrack {

	private Logger logger=Logger.getLogger(JINJIANGTracking.class);
	...
	public TrackingInfo doTrack(String url, Map<String, Object> params,boolean isPost){
		...
		try
		{
			...
			info.setTitle("JINGJIANG Tracking Result");
			if (entity != null) {
				String data = EntityUtils.toString(entity);
				Parser parser = new Parser(data);
				AndFilter filter = getAndFilter("table", "class", "font12-2");
			...
			logger.error("JINGJIANG 数据采集出错"+e);
		}
		return info;
	}
