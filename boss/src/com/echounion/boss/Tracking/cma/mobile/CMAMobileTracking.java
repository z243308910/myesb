package com.echounion.boss.Tracking.cma.mobile;
...
public class CMAMobileTracking extends AbstractTrack{

	private Logger logger=Logger.getLogger(CMAMobileTracking.class);
	...
	public TrackingInfo doTrack(String url, Map<String, Object> params, boolean isPost){
		...
		try
		{
			...
			e.printStackTrace();
			logger.error("CMA Mobile 数据采集出错:"+e);
		}
		return info;
	}
	...
	private TrackingInfo getContainerInfo(String data) throws Exception 
	{
		...
		AndFilter filter = getAndFilter("table", "id", "container-moves");
