package com.echounion.boss.Tracking.namsung;
...
public class NAMSUNGTracking extends AbstractTrack {

	private Logger logger=Logger.getLogger(NAMSUNGTracking.class);
	
	@Override
	public TrackingInfo doTrack(String url, Map<String, Object> params,
			boolean isPost){
		...
		try
		{
			...
			info.setTitle("NAMSUNG Tracking Result");
			if (entity != null) {
				String data = EntityUtils.toString(entity);
				Parser parser = new Parser(data);
				AndFilter filter = getAndFilter("table", "class", "tbd f11");
